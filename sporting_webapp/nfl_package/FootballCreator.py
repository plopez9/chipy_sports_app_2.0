...
Defense = FootballData(2019).DefenseData(1,6)
DefenseSummary = FootballData(2019).DefenseSummary(1,6)
NFLStats = FootballData(2019).YearData(1,6)
NFLSummary = FootballData(2019).PlayerSummary(1,6)
